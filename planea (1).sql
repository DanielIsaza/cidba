...
--
-- Servidor: localhost
-- Tiempo de generación: 28-08-2017 a las 05:28:35
...
CREATE TABLE `academicplans` (
  `id` int(10) UNSIGNED NOT NULL,
  `nombre` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `perfil` varchar (400) COLLATE utf8_unicode_ci,
...
(3, 'Retirado', '2017-07-25 07:27:32', '2017-07-25 07:27:32');
...
(1, 'Jose Daniel Isaza', 'admin@gmail.com', '$2y$10$1gHL5AgRa1jf/PSlk3sDMOQh0JxC9h09cfG4vXezzNP66bD5LFkIG', 'ZF515TF8xNxQfuJF2uANYQHa9yKDWHOXJwG6hOAtpIpL7l2mIyI8H8fXyXus', '2017-08-10 08:10:34', '2017-08-10 08:17:13');
...
ALTER TABLE `abilities`
  ...
  ADD KEY `abilities_academicplan_id_foreign` (`academicplan_id`);
...
--
ALTER TABLE `abilities`
  ADD CONSTRAINT `abilities_academicplan_id_foreign` FOREIGN KEY (`academicplan_id`) REFERENCES `academicplans` (`id`),
